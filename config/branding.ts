...
export const palette = {
  ...
  gray400: "#a2aab2",
  gray200: "#e1e3e6",
  /** Sampled from the supplied logo file itself: the mark is exactly
   *  #D33829 vermilion and #000000 black on white. */
  red600: "#d33829",
  red500: "#a51404",
  ochre500: "#d79023",
  ochre600: "#a06a12",
 ...
 */
export const themes = {
  // The logo leads: vermilion #D33829 accent, black-linework ink. The
  // website's supporting colours stay — sand grounds, teal water, ochre.
  // Status hues stay semantic.
  light: {
    bg: "#f7f4ef",
    surface: "#fdfcfa",
    raised: "#ffffff",
...
> = {
  ...
  "RT-ESC": {
    light: { strong: palette.red600, soft: "#fbebe8" },
    dark: { strong: "#e8695a", soft: "#3c1f1a" },
  },
  "RT-FLT": {
